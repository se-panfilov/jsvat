System.register([], function (exports_1, context_1) {
    "use strict";
    var generateCheckSums, isRepeatedArray, getRemaining, brazil;
    ...
    return {
        ...
        execute: function () {
             ...
             */
            generateCheckSums = (numbers, validators) => {
            ...
            isRepeatedArray = (varNumbers) => varNumbers.every((varNumber) => varNumbers[0] === varNumber);
            /**
             * Get remaining of 11 or `0` if lower than 2.
             * @param value - Value used remaining.
             */
            getRemaining = (value) => (value % 11 < 2 ? 0 : 11 - (value % 11));
            exports_1("brazil", brazil = {
                name: 'Brazil',
                codes: ['BR', 'BRA', '076'],
                calcFn: (vat) => {
