...
describe("Austria VAT.", function () {
  ...
  //
  //     it("Valid VAT", function () {
  //       expect(jsvat.checkVAT('ATU00000024')).to.be.false;
  //       expect(jsvat.checkVAT('ATU00000033')).to.be.false;
  //       expect(jsvat.checkVAT('ATU00000042')).to.be.false;
  //       expect(jsvat.checkVAT('ATU00000202')).to.be.false;
  //       expect(jsvat.checkVAT('ATU00000060')).to.be.false;
  //     });
  //
  //     it("Invalid VAT", function () {
  //       expect(jsvat.checkVAT('ATV66889218')).to.be.false;
  ...
  //
  //     it("Valid VAT with spaces", function () {
  //       expect(jsvat.checkVAT('ATU 0000 0024')).to.be.false;
  //     });
  //
  //     it("Valid VAT with '-'", function () {
  //       expect(jsvat.checkVAT('ATU-000-00024')).to.be.false;
  //     });
  //
  //     after(function () {
  //       jsvat.config = {};
