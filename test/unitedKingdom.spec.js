import { unitedKingdom, getVATExample, checkVAT } from '../index';
...
describe('United Kingdom', () => {
  ...
  it('should example be a valid format', () => {
    const example = getVATExample(unitedKingdom);

    expect(checkVAT(example, [unitedKingdom]).isValidFormat).toBe(true);
  });
});
